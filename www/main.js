...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_11__.NgModule)({
        ...
        providers: [
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_9__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_13__.IonicRouteStrategy },
        ],
...
let AuthenticationService = class AuthenticationService {
    ...
    login(user) {
        let host = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseUrl;
        let jwt;
